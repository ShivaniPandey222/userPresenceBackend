...
//        presenceService.refreshUserPresence(noteId, username);
//        if (noteId == null || username == null) {
//            return ResponseEntity.badRequest().body(Map.of("error", "Invalid request"));
//        }
//
//        // ✅ Forcefully re-add user
//        usersViewingNotes.computeIfAbsent(noteId, k -> ConcurrentHashMap.newKeySet()).remove(username);
//        usersViewingNotes.get(noteId).add(username);
//
//        // ✅ Sync with Redis
//        presenceService.removeUser(noteId, username);
//        presenceService.addUser(noteId, username);
//
//        logger.info("User '{}' re-added to note '{}'. Current users: {}", username, noteId, usersViewingNotes.get(noteId));
//
...
//        }
//
//        boolean removedFromLocal = usersViewingNotes.computeIfPresent(noteId, (key, users) -> {
//            users.remove(username);
//            return users.isEmpty() ? null : users;
//        }) != null;
//
//        boolean removedFromRedis = presenceService.getUsersViewing(noteId).contains(username);
//        if (removedFromRedis) {
//            presenceService.removeUser(noteId, username);
//        }
//
...
//
//        // ✅ Remove old emitter before adding a new one
...
//            logger.info("SSE connection completed for note {}", noteId);
//            removePresenceEmitter(noteId, emitter);
//        });
//
//        emitter.onTimeout(() -> {
//            logger.info("SSE connection timed out for note {}", noteId);
//            removePresenceEmitter(noteId, emitter);
//        });
//
//        notifyPresenceUpdate(noteId);
...
//            } catch (IOException e) {
//                logger.warn("Failed to send heartbeat for note {}: {}", noteId, e.getMessage());
//                removePresenceEmitter(noteId, emitter);
//                emitter.complete();
//            }
...
//        Set<String> redisUsers = presenceService.getUsersViewing(noteId);
//
//        logger.info("Notifying presence update for note {}: {} (Redis: {})", noteId, users, redisUsers);
//
